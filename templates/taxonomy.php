...
//  if the get_option is true use the get_option otherwise use an empty array to store in the $options variable
		...
		<div id="tab-2" class="tab-pane <?php echo isset($_POST["edit_taxonomy"]) ? 'active' : ''  ?>">
			<form method="post" action="options.php">
				<?php
				settings_fields( 'matts_plugin_tax_settings' );
				do_settings_sections( 'matts_taxonomy' );
				submit_button(); 
				?>
			</form>	
		</div>
